...
TEXTOS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "copilot_plan_note_free":       "Barra: completions este mes / {completions} (límite free).\nChat: hasta {chat} requests/mes.",
        "copilot_plan_note_pro":        "Barra: completions este mes / {ref} (ref. configurable).\nSin límite fijo — ajustá la referencia a tu uso real.",
        "copilot_plan_note_enterprise": "Barra: completions este mes / {ref} (ref. configurable).\nSin visibilidad en web desde jun 2026 — este monitor es tu única vista.",
        "copilot_plan_note_unknown":    "Seleccioná tu plan para calibrar la barra.",
        "copilot_req_ref_label":        "Ref. mensual (req)",
    ...
    "en": {
        ...
        "copilot_plan_note_free":       "Bar: completions this month / {completions} (free limit).\nChat: up to {chat} requests/month.",
        "copilot_plan_note_pro":        "Bar: completions this month / {ref} (configurable ref).\nNo fixed limit — set the reference to your typical usage.",
        "copilot_plan_note_enterprise": "Bar: completions this month / {ref} (configurable ref).\nNo web visibility since Jun 2026 — this monitor is your only view.",
        "copilot_plan_note_unknown":    "Select your plan to calibrate the bar.",
        "copilot_req_ref_label":        "Monthly ref. (req)",
